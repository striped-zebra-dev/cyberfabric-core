//! Mock upstream server for OAGW integration tests.
//!
//! Provides a reusable test harness that simulates upstream services (OpenAI-compatible
//! HTTP JSON, SSE streaming, error conditions, WebSocket, WebTransport stub).
//!
//! # Usage
//! ```ignore
