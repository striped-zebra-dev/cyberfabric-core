...
pub(super) fn register(mut router: Router, openapi: &dyn OpenApiRegistry) -> Router {
    ...
    // GET /api/oagw/v1/upstreams/{id} — Get upstream
    router = OperationBuilder::get("/api/oagw/v1/upstreams/{id}")
    ...
    router = OperationBuilder::put("/api/oagw/v1/upstreams/{id}")
    ...
    router = OperationBuilder::delete("/api/oagw/v1/upstreams/{id}")
