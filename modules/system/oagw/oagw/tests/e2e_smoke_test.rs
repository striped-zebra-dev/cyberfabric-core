...
use oagw_cp::test_support::TestCpBuilder;
use oagw_dp::test_support::{APIKEY_AUTH_PLUGIN_ID, TestDpBuilder};
use oagw_sdk::gts;
...
async fn e2e_chat_completion_round_trip() {
    ...
    let resp = send(
        h.app.clone(),
        Method::POST,
        "/api/oagw/v1/proxy/e2e-openai/v1/chat/completions",
        h.tenant,
        Some(chat_body),
    )
    .await;
...
async fn e2e_sse_streaming() {
    ...
    let resp = send(
        h.app.clone(),
        Method::POST,
        "/api/oagw/v1/proxy/e2e-sse/v1/chat/completions/stream",
        h.tenant,
...
async fn e2e_auth_injection() {
    ...
    let resp = send(
        h.app.clone(),
        Method::POST,
        "/api/oagw/v1/proxy/e2e-auth/echo",
        h.tenant,
...
async fn e2e_nonexistent_alias_returns_404() {
    ...
    let resp = send(
        h.app.clone(),
        Method::GET,
        "/api/oagw/v1/proxy/nonexistent/v1/test",
        h.tenant,
        None,
    )
    .await;
...
async fn e2e_disabled_upstream_returns_503() {
    ...
    let resp = send(
        h.app.clone(),
        Method::GET,
        "/api/oagw/v1/proxy/e2e-disabled/v1/test",
        h.tenant,
        None,
    )
    .await;
...
async fn e2e_upstream_500_passthrough() {
    ...
    let resp = send(
        h.app.clone(),
        Method::GET,
        "/api/oagw/v1/proxy/e2e-errors/error/500",
        h.tenant,
        None,
    )
    .await;
...
async fn e2e_rate_limit_returns_429() {
    ...
    let resp = send(
        h.app.clone(),
        Method::GET,
        "/api/oagw/v1/proxy/e2e-rl/v1/models",
        h.tenant,
        None,
    )
    .await;
...
async fn e2e_management_lifecycle() {
    ...
    let resp = send(
        h.app.clone(),
        Method::PUT,
        &format!("/api/oagw/v1/upstreams/{uid}"),
        h.tenant,
...
async fn e2e_invalid_content_length_returns_400() {
    ...
    let req = Request::builder()
        .method(Method::POST)
        .uri("/api/oagw/v1/proxy/e2e-cl/v1/test")
...
async fn e2e_body_exceeding_limit_returns_413() {
    ...
    let req = Request::builder()
        .method(Method::POST)
        .uri("/api/oagw/v1/proxy/e2e-big/v1/test")
        .header("x-tenant-id", h.tenant.to_string())
        .header("content-type", "application/json")
...
async fn e2e_upstream_timeout_returns_504() {
    ...
    let resp = send(
        app.clone(),
        Method::GET,
        "/api/oagw/v1/proxy/e2e-timeout/error/timeout",
        tenant,
        None,
    )
    .await;
