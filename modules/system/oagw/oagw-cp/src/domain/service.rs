...
impl ControlPlaneService for ControlPlaneServiceImpl {
    ...
    async fn create_upstream(
        ...
        self.upstreams
            .create(upstream)
            .await
            .map_err(|e| map_repo_error(e, "/api/oagw/v1/upstreams"))
    }
    ...
    async fn get_upstream(&self, tenant_id: Uuid, id: Uuid) -> Result<Upstream, OagwError> {
        self.upstreams
            ...
            .await
            .map_err(|e| map_repo_error(e, &format!("/api/oagw/v1/upstreams/{id}")))
    }
    ...
    async fn update_upstream(
        ...
        let instance = format!("/api/oagw/v1/upstreams/{id}");
    ...
    async fn create_route(
        ...
        let instance = "/api/oagw/v1/routes";
        self.upstreams
    ...
    async fn get_route(&self, tenant_id: Uuid, id: Uuid) -> Result<Route, OagwError> {
        self.routes
            .get_by_id(tenant_id, id)
            .await
            .map_err(|e| map_repo_error(e, &format!("/api/oagw/v1/routes/{id}")))
    }
    ...
    async fn list_routes(
        ...
        self.routes
            ...
            .await
            .map_err(|e| map_repo_error(e, "/api/oagw/v1/routes"))
    }
    ...
    async fn update_route(
        ...
        let instance = format!("/api/oagw/v1/routes/{id}");
        let mut existing = self
            .routes
            .get_by_id(tenant_id, id)
            .await
    ...
    async fn resolve_upstream(&self, tenant_id: Uuid, alias: &str) -> Result<Upstream, OagwError> {
        let upstream = self
            ...
            .map_err(|_| OagwError::RouteNotFound {
                instance: format!("/api/oagw/v1/proxy/{alias}"),
            })?;
    ...
    async fn resolve_route(
        ...
        self.routes
            ...
            .await
            .map_err(|_| OagwError::RouteNotFound {
                instance: format!("/api/oagw/v1/proxy (method={method}, path={path})"),
            })
    }
}
...
mod tests {
    ...
    use crate::domain::repo::{InMemoryRouteRepo, InMemoryUpstreamRepo};
